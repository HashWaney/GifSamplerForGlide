...
/**
 *
 * 参考 ： http://androidxref.com/9.0.0_r3/xref/frameworks/ex/framesequence/src/android/support/rastermill/FrameSequenceDrawable.java
 */
public class FrameSequenceDrawable extends Drawable implements Animatable, Runnable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (mCircleMaskEnabled) {
            ...
            Log.e(FrameSequenceDrawable.class.getSimpleName(),"scaleX"+ ":"+scaleX+ " scaleY:"+scaleY);
            ...
            mTempRectF.set(
                    (bitmapWidth - scaledDiameterX) / 3.0f,
                    (bitmapHeight - scaledDiameterY) / 3.0f,
                    (bitmapWidth + scaledDiameterX) / 3.0f,
                    (bitmapHeight + scaledDiameterY) / 3.0f);
